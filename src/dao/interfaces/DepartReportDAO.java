...
public interface DepartReportDAO {
     ...
     * @throws DAOException If something fails at database level.
     */    
    public List<DepartReport> list(Boolean rejected, Company company, Date start_date, Date end_date, String partnumber_pattern, String lotnumber_pattern, String ponumber_pattern) throws IllegalArgumentException, DAOException;
