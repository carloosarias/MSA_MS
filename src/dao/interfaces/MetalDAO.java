...
public interface MetalDAO {
    ...
    /**
     * Returns the Metal from the database matching the given name, otherwise null.
     * @param name The name of the Metal to be returned.
     * @return The Metal from the database matching the given name, otherwise null.
     * @throws DAOException If something fails at database level.
     */
     ...
     * @return A list of all Metals from the database ordered by Metal ID.
     * @throws DAOException If something fails at database level.
     */    
    public List<Metal> list() throws DAOException;
    
    /**
     * Create the given Metal in the database. The Metal ID must be null, otherwise it will throw
     * IllegalArgumentException. After creating, the DAO will set the obtained ID in the given Metal.
     * @param metal The Metal to be created in the database.
    ...
    /**
     * Update the given Metal in the database. The Metal ID must not be null, otherwise it will throw
     * IllegalArgumentException.
     * @param metal The Metal to be updated in the database.
