...
public class POQueryFX implements Initializable {
    ...
    public void updatePOQueryTable(){
        poquery_tableview.getItems().setAll(msabase.getPOQueryDAO().list(ponumber_field.getText(), company_combo.getSelectionModel().getSelectedItem(), partnumber_field.getText()));
    }
